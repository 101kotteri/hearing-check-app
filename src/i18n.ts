...
const DICTIONARY: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    'plan.buyA': '有料プランA（+4ポイント）',
    'plan.buyB': '有料プランB（全ポイント＋PDF/画像保存）',
    'plan.upgradeToB': 'プランB-Aにアップグレード（+2ポイント＋PDF/画像保存）',
    'done.disclaimer':
  ...
  en: {
    ...
    'plan.buyA': 'Plan A (+4 points)',
    'plan.buyB': 'Plan B (all points + PDF/image export)',
    'plan.upgradeToB': 'Upgrade to Plan B-A (+2 points + PDF/image export)',
    'done.disclaimer':
  ...
  zh: {
    ...
    'plan.buyA': '方案A（+4个测量点）',
    'plan.buyB': '方案B（全部测量点+PDF/图片导出）',
    'plan.upgradeToB': '升级到方案B-A（+2个测量点+PDF/图片导出）',
    'done.disclaimer':
  ...
  de: {
    ...
    'plan.buyA': 'Plan A (+4 Punkte)',
    'plan.buyB': 'Plan B (alle Punkte + PDF-/Bildexport)',
    'plan.upgradeToB': 'Auf Plan B-A upgraden (+2 Punkte + PDF-/Bildexport)',
    'done.disclaimer':
  ...
  ko: {
    ...
    'plan.buyA': '플랜 A (+4포인트)',
    'plan.buyB': '플랜 B (전체 포인트 + PDF/이미지 저장)',
    'plan.upgradeToB': '플랜 B-A로 업그레이드 (+2포인트 + PDF/이미지 저장)',
    'done.disclaimer':
  ...
  es: {
    ...
    'plan.buyA': 'Plan A (+4 puntos)',
    'plan.buyB': 'Plan B (todos los puntos + exportación a PDF/imagen)',
    'plan.upgradeToB': 'Mejorar a Plan B-A (+2 puntos + exportación a PDF/imagen)',
    'done.disclaimer':
  ...
  fr: {
    ...
    'plan.buyA': "Offre A (+4 points)",
    'plan.buyB': "Offre B (tous les points + export PDF/image)",
    'plan.upgradeToB': "Passer à l'offre B-A (+2 points + export PDF/image)",
    'done.disclaimer':
  ...
  pt: {
    ...
    'plan.buyA': 'Plano A (+4 pontos)',
    'plan.buyB': 'Plano B (todos os pontos + exportação em PDF/imagem)',
    'plan.upgradeToB': 'Fazer upgrade para o Plano B-A (+2 pontos + exportação em PDF/imagem)',
    'done.disclaimer':
