...
const DICTIONARY: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    'plan.buyB': '有料プランMax（63Hz〜12.5kHz＋PDF/画像保存）',
    'plan.upgradeToB': 'Max Upgrade（63Hz, 10kHz, 12.5kHzを追加＋PDF/画像保存）',
    'plan.processing': '処理中…',
  ...
  en: {
    ...
    'plan.buyB': 'Plan Max (63Hz-12.5kHz + PDF/image export)',
    'plan.upgradeToB': 'Max Upgrade (adds 63Hz, 10kHz, 12.5kHz + PDF/image export)',
  ...
  zh: {
    ...
    'plan.buyB': '方案Max（63Hz〜12.5kHz+PDF/图片导出）',
    'plan.upgradeToB': 'Max Upgrade（新增63Hz、10kHz、12.5kHz+PDF/图片导出）',
    'plan.processing': '处理中…',
  ...
  de: {
    ...
    'plan.buyA': 'Plan Standard (125Hz-8kHz)',
    'plan.buyB': 'Plan Max (63Hz-12.5kHz + PDF-/Bildexport)',
    'plan.upgradeToB': 'Max Upgrade (fügt 63Hz, 10kHz, 12.5kHz hinzu + PDF-/Bildexport)',
  ...
  ko: {
    ...
    'plan.buyB': '플랜 Max (63Hz~12.5kHz + PDF/이미지 저장)',
    'plan.upgradeToB': 'Max Upgrade (63Hz, 10kHz, 12.5kHz 추가 + PDF/이미지 저장)',
  ...
  es: {
    ...
    'plan.buyA': 'Plan Standard (125Hz-8kHz)',
    'plan.buyB': 'Plan Max (63Hz-12.5kHz + exportación a PDF/imagen)',
    'plan.upgradeToB': 'Max Upgrade (añade 63Hz, 10kHz, 12.5kHz + exportación a PDF/imagen)',
  ...
  fr: {
    ...
    'plan.buyB': 'Offre Max (63Hz-12.5kHz + export PDF/image)',
    'plan.upgradeToB': 'Max Upgrade (ajoute 63Hz, 10kHz, 12.5kHz + export PDF/image)',
  ...
  pt: {
    ...
    'plan.buyB': 'Plano Max (63Hz-12.5kHz + exportação em PDF/imagem)',
    'plan.upgradeToB': 'Max Upgrade (adiciona 63Hz, 10kHz, 12.5kHz + exportação em PDF/imagem)',
